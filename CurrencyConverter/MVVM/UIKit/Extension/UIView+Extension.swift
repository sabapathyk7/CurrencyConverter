...
extension UIView {
    ...
    func anchorCenter(centerX: NSLayoutXAxisAnchor? = nil, centerY: NSLayoutYAxisAnchor? = nil, inset: UIEdgeInsets = .zero) {
    ...
    func anchorDimension(width: NSLayoutDimension? = nil, height: NSLayoutDimension? = nil, inset: UIEdgeInsets = .zero) {
        translatesAutoresizingMaskIntoConstraints = false
